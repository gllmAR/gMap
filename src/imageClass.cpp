...
void imageClass::setup(int index, string path){
    ...
    oscPath = string("/warper/")+std::to_string(index);
    xmlPath = string ("warper")+std::to_string(index);
    myIndex = index;
...
void imageClass::loadXML(ofxXmlSettings XML, int preset){
...
void imageClass::saveXML(ofxXmlSettings XML, int preset){
...
void imageClass::update(ofxOscMessage m){
